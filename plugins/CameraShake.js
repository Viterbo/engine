  ...
  this._shakeCamera = function () {
    ...
    this._settings.shakeInterval) : this._settings.shakeInterval, function () {
      ...
      if (this._settings.randomShake) {
        ...
        shift1 = this.game.rnd.integerInRange(-this._settings.shakeRange / 2, this._settings.shakeRange / 2);
        shift2 = this.game.rnd.integerInRange(-this._settings.shakeRange / 2, this._settings.shakeRange / 2);
